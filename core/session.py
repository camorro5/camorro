...
class Session:
    ...
    LANGS = ["en-US,en;q=0.9", "en-GB,en;q=0.9", "en-US,en;q=0.9,ar;q=0.8", "fr-FR,fr;q=0.9,en;q=0.8", "ar-MA,ar;q=0.9,en;q=0.8"]
    ...
    @classmethod
    def ig_app_ua(cls): return random.choice(cls.IG_APP_UA)

    @classmethod
    def new_device_ids(cls):
        return {"X-IG-Device-ID": str(uuid.uuid4()), "X-IG-Family-Device-ID": str(uuid.uuid4()),
    ...
    def build_headers(cls, username=None, mobile=True, for_api=True):
        ...
        ref = f"https://www.instagram.com/{username}/" if username else "https://www.instagram.com/"
        if for_api:
            return {"User-Agent": ua, "Accept": "*/*", "Accept-Language": random.choice(cls.LANGS),
                    "Accept-Encoding": "gzip, deflate", "Origin": "https://www.instagram.com", "Referer": ref,
                    "Connection": "keep-alive", "Sec-Fetch-Dest": "empty", "Sec-Fetch-Mode": "cors",
                    "Sec-Fetch-Site": "same-origin", "X-IG-App-ID": cls.APP_ID, "X-Requested-With": "XMLHttpRequest",
                    "X-ASBD-ID": "129477", "X-IG-WWW-Claim": "0", "DNT": "1"}
        return {"User-Agent": ua, "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8",
                "Accept-Language": random.choice(cls.LANGS), "Accept-Encoding": "gzip, deflate",
                "Connection": "keep-alive", "Upgrade-Insecure-Requests": "1", "Sec-Fetch-Dest": "document",
                "Sec-Fetch-Mode": "navigate", "Sec-Fetch-Site": "none", "Sec-Fetch-User": "?1", "DNT": "1"}
